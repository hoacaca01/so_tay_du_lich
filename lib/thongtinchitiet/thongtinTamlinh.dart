...
class ThongtinTamlinh extends StatefulWidget {
  final String image;
  ...
  const ThongtinTamlinh({super.key, required this.image, required this.location, required this.date, required this.introduction, required this.address, required this.vitrimap});
  @override
  State<ThongtinTamlinh> createState() => _ThongtinTamlinhState();
}

class _ThongtinTamlinhState extends State<ThongtinTamlinh> {
            ...
            child: Column(
              ...
              children: <Widget>[
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: <Widget>[
                    Text("Thông Tin Tâm Linh Chi Tiết",
                      style: TextStyle(
                          fontSize: 20,
                          color: Colors.black,
