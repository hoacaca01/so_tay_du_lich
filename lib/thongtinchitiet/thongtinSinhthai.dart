...
class ThongtinSinhthai extends StatefulWidget {
  final String image;
  ...
  const ThongtinSinhthai({super.key, required this.image, required this.location, required this.date, required this.introduction, required this.address, required this.vitrimap});
  @override
  State<ThongtinSinhthai> createState() => _ThongtinSinhthaiState();
}

class _ThongtinSinhthaiState extends State<ThongtinSinhthai> {
            ...
            child: Column(
              ...
              children: <Widget>[
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: <Widget>[
                    Text("Thông Tin Sinh Thái Chi Tiết",
                      style: TextStyle(
                          fontSize: 20,
                          color: Colors.black,
