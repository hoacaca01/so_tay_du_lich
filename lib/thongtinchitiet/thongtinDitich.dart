...
class ThongtinDitich extends StatefulWidget {
  final String image;
  ...
  const ThongtinDitich({super.key, required this.image, required this.location, required this.date, required this.introduction, required this.address, required this.vitrimap});
  @override
  State<ThongtinDitich> createState() => _ThongtinDitichState();
}

class _ThongtinDitichState extends State<ThongtinDitich> {
  @override
